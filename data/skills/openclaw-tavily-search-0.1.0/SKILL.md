---
name: tavily-search
description: "Web search via Tavily API. Use when the user asks to search the web / look up sources / find links. Jarvis exposes this as the tavily_search tool and returns a small set of relevant results (title, url, snippet) with optional short answer summaries."
---
...
# stable schema for Jarvis tavily_search: {query, results:[{title,url,snippet}], answer?}
