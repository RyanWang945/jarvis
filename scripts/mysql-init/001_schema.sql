-- Jarvis V1 Core Schema
-- Database: jarvis
-- Tables: users, conversations, messages, turns, tool_calls
...
-- -----------------------------------------------------
-- Table: messages
-- defer turn_id FK to avoid circular reference with turns.trigger_message_id
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table: turns
-- defer trigger_message_id FK to avoid circular reference
-- -----------------------------------------------------
...
ALTER TABLE turns
    ADD CONSTRAINT fk_turns_trigger_message FOREIGN KEY (trigger_message_id) REFERENCES messages(id) ON DELETE SET NULL;

ALTER TABLE conversations
    ADD CONSTRAINT fk_conversations_owner_user FOREIGN KEY (owner_user_id) REFERENCES users(id) ON DELETE SET NULL,
    ADD CONSTRAINT fk_conversations_created_by FOREIGN KEY (created_by_user_id) REFERENCES users(id) ON DELETE SET NULL,
