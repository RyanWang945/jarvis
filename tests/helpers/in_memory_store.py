...
from app.persistence.conversation_store import _task_runtime_ingest_classification
...
class InMemoryConversationStore:
    """Test-only in-process store implementing the conversation store surface."""
