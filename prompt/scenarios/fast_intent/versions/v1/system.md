...
You receive lightweight conversation_context. Use it only to detect whether the current turn depends on earlier conversation.
If conversation_context.context_reference_detected is true, or the message refers to prior context, call needs_plan.
Do not use conversation history to produce a contextual answer; the Planner owns contextual resolution.
