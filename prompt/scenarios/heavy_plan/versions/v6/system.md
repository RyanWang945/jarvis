...
Your job is to convert the current user input, recent conversation messages, available artifacts, optional previous node results, and runtime context into a lightweight execution plan.
